...
export default function Page() {
  ...
  const handleSearch = async () => {
    ...
    setTimeout(() => {
      ...
      setLogs((x) => [...x, { title: \"Rank\", detail: \"Ranked 3 candidates by platform fit and actuator density.\" }]);
      setLoading(false);
    }, 800);
  };
      ...
      <div className=\"mx-auto max-w-6xl px-4 py-6\">
        ...
        <div className=\"grid grid-cols-1 lg:grid-cols-3 gap-6\">
          <div className=\"lg:col-span-2 space-y-4\">
            ...
            {results.length === 0 && (
              <Card>
                <div className=\"text-sm text-gray-600\">No results yet. Click <b>Find companies</b> to begin.</div>
              </Card>
            )}
            {results.map((c) => (
          ...
          <div className=\"space-y-4\">
            <Card>
              <h3 className=\"text-base font-semibold mb-1 flex items-center gap-2\"><Sparkles size={16}/> Agent run log</h3>
            ...
            <Card>
              <h3 className=\"text-base font-semibold mb-1 flex items-center gap-2\"><Bug size={16}/> Dev tests</h3>
